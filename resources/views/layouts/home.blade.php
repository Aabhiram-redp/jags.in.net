...
<html>
  <head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="{{('public/css/main.min.css')}}" media="screen" title="no title" charset="utf-8">
      @yield('extra_css')
    <!-- End Stylesheets -->
  </head>
  <body>
    ...
    <!-- Scripts -->
      ...
      @yield('extra_js')
      <script type="text/javascript" src="{{('public/js/init/init.min.js')}}"></script>
    <!-- End Scripts -->
  </body>
</html>