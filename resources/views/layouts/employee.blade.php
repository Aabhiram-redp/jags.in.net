...
<html>
  <head>
    ...
    <link href="{{asset('efavicon.ico')}}" rel='shortcut icon'>
    ...
    <link href="{{asset('css/employee.min.css')}}" rel='stylesheet' type='text/css'>
  ...
  <body>
    ...
    @yield('extra_js')
    <script src="{{asset('js/employee/init.min.js')}}" type='text/javascript'></script>
  </body>
</html>
